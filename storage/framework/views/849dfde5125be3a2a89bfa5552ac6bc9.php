<?php $__env->startSection('header', 'Add Brand'); ?>
...
<div class="bg-white rounded-lg shadow p-6">
    <form method="POST" action="<?php echo e(route('brands.store')); ?>">
        ...
        <div class="flex gap-2">
            ...
            <a href="<?php echo e(route('brands.index')); ?>" class="px-4 py-2 border rounded-lg hover:bg-gray-50">Cancel</a>
        </div>
    </form>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\flourish\flourish\resources\views/brands/create.blade.php ENDPATH**/ ?>