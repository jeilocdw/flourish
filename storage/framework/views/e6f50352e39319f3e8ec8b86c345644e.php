<?php $__env->startSection('header', 'Low Stock Items'); ?>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody class="divide-y">
                ...
                <tr>
                    <td colspan="5" class="px-4 py-8 text-center text-gray-500">No low stock products found</td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\flourish\flourish\resources\views/inventory/low-stock.blade.php ENDPATH**/ ?>