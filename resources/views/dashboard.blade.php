    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-gray-800">${{ number_format($todayTotal, 2) }}</p>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a href="{{ route('products.create') }}" class="flex flex-col items-center justify-center p-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            ...
            <a href="{{ route('purchases.create') }}" class="flex flex-col items-center justify-center p-4 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
            ...
            <a href="{{ route('customers.create') }}" class="flex flex-col items-center justify-center p-4 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition">
