...
if ($action === 'install' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $migrations = [
            ...
            "CREATE TABLE IF NOT EXISTS sessions (id VARCHAR(255) PRIMARY KEY, user_id BIGINT UNSIGNED NULL, ip_address VARCHAR(45) NULL, user_agent TEXT NULL, payload LONGTEXT NULL, last_activity INT NULL) ENGINE=InnoDB"
        ];
