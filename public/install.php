...
if ($action === 'install' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($isPostgres) {
            ...
            $pdo->exec("DROP TABLE IF EXISTS sale_items CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS payments CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS sales CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS purchase_items CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS purchases CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS product_store CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS products CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS expenses CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS customers CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS suppliers CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS settings CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS units CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS categories CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS brands CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS users CASCADE");
            $pdo->exec("DROP TABLE IF EXISTS stores CASCADE");
            
            $pdo->exec("CREATE TABLE stores (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, code VARCHAR(255) UNIQUE NOT NULL, address TEXT, phone VARCHAR(255), email VARCHAR(255), currency VARCHAR(10) DEFAULT 'USD', currency_symbol VARCHAR(5) DEFAULT '$', is_active BOOLEAN DEFAULT true, is_default BOOLEAN DEFAULT false, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE users (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255) UNIQUE NOT NULL, password VARCHAR(255) NOT NULL, role VARCHAR(20) DEFAULT 'cashier', store_id BIGINT, is_active BOOLEAN DEFAULT true, remember_token VARCHAR(100), created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE categories (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE brands (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE units (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, short_name VARCHAR(10) NOT NULL, base_unit BIGINT, operator VARCHAR(10), operator_value DECIMAL(10,2), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE products (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, sku VARCHAR(255) UNIQUE NOT NULL, barcode VARCHAR(255), category_id BIGINT, brand_id BIGINT, unit_id BIGINT, cost_price DECIMAL(10,2) DEFAULT 0, sell_price DECIMAL(10,2) DEFAULT 0, tax_rate DECIMAL(5,2) DEFAULT 0, alert_quantity INT DEFAULT 10, expiry_date DATE, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE product_store (id SERIAL PRIMARY KEY, product_id BIGINT NOT NULL, store_id BIGINT NOT NULL, quantity INT DEFAULT 0, alert_quantity INT DEFAULT 10, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, UNIQUE(product_id, store_id))");
            $pdo->exec("CREATE TABLE customers (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255), phone VARCHAR(255), address TEXT, city VARCHAR(255), country VARCHAR(255), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE suppliers (id SERIAL PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255), phone VARCHAR(255), address TEXT, city VARCHAR(255), country VARCHAR(255), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE sales (id SERIAL PRIMARY KEY, invoice VARCHAR(255) UNIQUE NOT NULL, store_id BIGINT NOT NULL, customer_id BIGINT, user_id BIGINT NOT NULL, subtotal DECIMAL(10,2) DEFAULT 0, tax DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, paid DECIMAL(10,2) DEFAULT 0, change_amount DECIMAL(10,2) DEFAULT 0, payment_method VARCHAR(20) DEFAULT 'cash', status VARCHAR(20) DEFAULT 'completed', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE sale_items (id SERIAL PRIMARY KEY, sale_id BIGINT NOT NULL, product_id BIGINT NOT NULL, quantity INT DEFAULT 1, unit_price DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE payments (id SERIAL PRIMARY KEY, sale_id BIGINT NOT NULL, amount DECIMAL(10,2) DEFAULT 0, payment_method VARCHAR(20) DEFAULT 'cash', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE purchases (id SERIAL PRIMARY KEY, invoice VARCHAR(255) UNIQUE NOT NULL, supplier_id BIGINT, store_id BIGINT NOT NULL, user_id BIGINT NOT NULL, total DECIMAL(10,2) DEFAULT 0, status VARCHAR(20) DEFAULT 'completed', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE purchase_items (id SERIAL PRIMARY KEY, purchase_id BIGINT NOT NULL, product_id BIGINT NOT NULL, quantity INT DEFAULT 1, unit_cost DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE expenses (id SERIAL PRIMARY KEY, store_id BIGINT NOT NULL, category VARCHAR(255) NOT NULL, amount DECIMAL(10,2) DEFAULT 0, description TEXT, date DATE NOT NULL, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            $pdo->exec("CREATE TABLE settings (id SERIAL PRIMARY KEY, key VARCHAR(255) UNIQUE NOT NULL, value TEXT, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL)");
            ...
            $pdo->exec("DROP TABLE IF EXISTS purchase_items");
            $pdo->exec("DROP TABLE IF EXISTS purchases");
            $pdo->exec("DROP TABLE IF EXISTS product_store");
            ...
            $pdo->exec("CREATE TABLE stores (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, code VARCHAR(255) UNIQUE NOT NULL, address TEXT, phone VARCHAR(255), email VARCHAR(255), currency VARCHAR(10) DEFAULT 'USD', currency_symbol VARCHAR(5) DEFAULT '$', is_active BOOLEAN DEFAULT true, is_default BOOLEAN DEFAULT false, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE users (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255) UNIQUE NOT NULL, password VARCHAR(255) NOT NULL, role ENUM('admin','manager','cashier') DEFAULT 'cashier', store_id BIGINT UNSIGNED, is_active BOOLEAN DEFAULT true, remember_token VARCHAR(100), created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE categories (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE brands (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE units (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, short_name VARCHAR(10) NOT NULL, base_unit BIGINT UNSIGNED, operator VARCHAR(10), operator_value DECIMAL(10,2), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE products (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, sku VARCHAR(255) UNIQUE NOT NULL, barcode VARCHAR(255), category_id BIGINT UNSIGNED, brand_id BIGINT UNSIGNED, unit_id BIGINT UNSIGNED, cost_price DECIMAL(10,2) DEFAULT 0, sell_price DECIMAL(10,2) DEFAULT 0, tax_rate DECIMAL(5,2) DEFAULT 0, alert_quantity INT DEFAULT 10, expiry_date DATE, is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE product_store (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, product_id BIGINT UNSIGNED NOT NULL, store_id BIGINT UNSIGNED NOT NULL, quantity INT DEFAULT 0, alert_quantity INT DEFAULT 10, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL, UNIQUE KEY product_store (product_id, store_id)) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE customers (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255), phone VARCHAR(255), address TEXT, city VARCHAR(255), country VARCHAR(255), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE suppliers (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(255) NOT NULL, email VARCHAR(255), phone VARCHAR(255), address TEXT, city VARCHAR(255), country VARCHAR(255), is_active BOOLEAN DEFAULT true, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE sales (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, invoice VARCHAR(255) UNIQUE NOT NULL, store_id BIGINT UNSIGNED NOT NULL, customer_id BIGINT UNSIGNED, user_id BIGINT UNSIGNED NOT NULL, subtotal DECIMAL(10,2) DEFAULT 0, tax DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, paid DECIMAL(10,2) DEFAULT 0, change_amount DECIMAL(10,2) DEFAULT 0, payment_method ENUM('cash','card','mobile','bank_transfer') DEFAULT 'cash', status ENUM('completed','pending','cancelled') DEFAULT 'completed', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE sale_items (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, sale_id BIGINT UNSIGNED NOT NULL, product_id BIGINT UNSIGNED NOT NULL, quantity INT DEFAULT 1, unit_price DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE payments (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, sale_id BIGINT UNSIGNED NOT NULL, amount DECIMAL(10,2) DEFAULT 0, payment_method ENUM('cash','card','mobile','bank_transfer') DEFAULT 'cash', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE purchases (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, invoice VARCHAR(255) UNIQUE NOT NULL, supplier_id BIGINT UNSIGNED, store_id BIGINT UNSIGNED NOT NULL, user_id BIGINT UNSIGNED NOT NULL, total DECIMAL(10,2) DEFAULT 0, status ENUM('completed','pending','ordered') DEFAULT 'completed', created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE purchase_items (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, purchase_id BIGINT UNSIGNED NOT NULL, product_id BIGINT UNSIGNED NOT NULL, quantity INT DEFAULT 1, unit_cost DECIMAL(10,2) DEFAULT 0, total DECIMAL(10,2) DEFAULT 0, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE expenses (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, store_id BIGINT UNSIGNED NOT NULL, category VARCHAR(255) NOT NULL, amount DECIMAL(10,2) DEFAULT 0, description TEXT, date DATE NOT NULL, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
            $pdo->exec("CREATE TABLE settings (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, key VARCHAR(255) UNIQUE NOT NULL, value TEXT, created_at TIMESTAMP NULL, updated_at TIMESTAMP NULL) ENGINE=InnoDB");
