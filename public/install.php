                    ...
                    <form id="database-form" onsubmit="setupDatabase(event)">
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="db_host" value="127.0.0.1" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" name="db_user" value="root" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent" required>
                            </div>
                            <div>
    ...
    try {
        ...
        $migrations = [
            ...
            "CREATE TABLE IF NOT EXISTS units (
                ...
                base_unit BIGINT UNSIGNED,
                operator VARCHAR(10),
                operator_value DECIMAL(10,2),
                is_active BOOLEAN DEFAULT true,
                created_at TIMESTAMP NULL,
                updated_at TIMESTAMP NULL,
                FOREIGN KEY (base_unit) REFERENCES units(id) ON DELETE SET NULL
            ) ENGINE=InnoDB",
            ...
            "CREATE TABLE IF NOT EXISTS purchases (
                ...
                user_id BIGINT UNSIGNED NOT NULL,
                total DECIMAL(10,2) DEFAULT 0,
                status ENUM('completed','pending','ordered') DEFAULT 'completed',
                created_at TIMESTAMP NULL,
                updated_at TIMESTAMP NULL,
        ...
        $pdo->exec("INSERT INTO stores (name, code, address, phone, email, currency, currency_symbol, is_active, is_default, created_at, updated_at) VALUES 
            ('Main Store', 'MAIN', '123 Main Street', '+1234567890', 'info@flourish.com', 'USD', '$', 1, 1, NOW(), NOW())");
        
        // Insert default unit
        $pdo->exec("INSERT INTO units (name, short_name, is_active, created_at, updated_at) VALUES 
            ('Piece', 'pc', 1, NOW(), NOW()),
        ...
        $pdo->exec("INSERT INTO categories (name, is_active, created_at, updated_at) VALUES 
            ('Groceries', 1, NOW(), NOW()),
            ('Beverages', 1, NOW(), NOW()),
            ('Snacks', 1, NOW(), NOW()),
            ('Household', 1, NOW(), NOW()),
            ('Personal Care', 1, NOW(), NOW())");
        
        // Insert default brands
        $pdo->exec("INSERT INTO brands (name, is_active, created_at, updated_at) VALUES 
            ('Generic', 1, NOW(), NOW()),
            ('Nestle', 1, NOW(), NOW()),
            ('Coca-Cola', 1, NOW(), NOW()),
            ('Unilever', 1, NOW(), NOW()),
            ('Procter & Gamble', 1, NOW(), NOW())");
        
        // Insert admin user (password: admin123)
        $password = password_hash('admin123', PASSWORD_BCRYPT);
        $pdo->exec("INSERT INTO users (name, email, password, role, store_id, is_active, created_at, updated_at) VALUES 
            ('Administrator', 'admin@example.com', '$password', 'admin', 1, 1, NOW(), NOW())");
        
        // Insert default settings
        $pdo->exec("INSERT INTO settings (`key`, value, created_at, updated_at) VALUES 
            ('store_name', 'Flourish Supermarket', NOW(), NOW()),
